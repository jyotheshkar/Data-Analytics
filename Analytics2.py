...
# Highlight peaks exceeding a certain threshold in red
threshold = 30  # Set your desired threshold
peaks = booking_counts[booking_counts['Number of Bookings'] > threshold]
plt.scatter(peaks['Time Interval'], peaks['Number of Bookings'], color='black', label='Peaks > Threshold')

# Plot line graph in black
plt.plot(booking_counts['Time Interval'], booking_counts['Number of Bookings'], marker='o', linestyle='-', color='black')
